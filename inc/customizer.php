...
/*function _s_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'new_section',
		array(
			'capability' 	=> 'edit_theme_options',
			'description' 	=> esc_html__( 'New Customizer Section', 'igrow-illinois' ),
			'panel' 		=> 'theme_options',
			'priority' 		=> 10,
			'title' 		=> esc_html__( 'New Section', 'igrow-illinois' )
		)
	);
	...
	$wp_customize->add_control(
		...
		array(
			'description' 	=> '',
			'label'  	=> esc_html__( 'Text Field', 'igrow-illinois' ),
			'section'  	=> 'new_section',
			'settings' 	=> 'text_field',
			'type' 		=> 'text'
		)
	...
	*/
	public static function register( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				'description' 	=> '',
				'label' => esc_html__( 'URL Field', 'igrow-illinois' ),
				'section' => 'new_section',
				'settings' => 'url_field',
				'type' => 'url'
			)
		...
		$wp_customize->add_control(
			...
			array(
				'description' 	=> '',
				'label' => esc_html__( 'Email Field', 'igrow-illinois' ),
				'section' => 'new_section',
		...
		$wp_customize->add_control(
			...
			array(
				'description' 	=> '',
				'label' => esc_html__( 'Date Field', 'igrow-illinois' ),
				'section' => 'new_section',
				'settings' => 'date_field',
				'type' => 'date'
			)
		...
		$wp_customize->add_control(
			...
			array(
				'description' => '',
				'label' => esc_html__( 'Checkbox Field', 'igrow-illinois' ),
				'section' => 'new_section',
...
/*
		...
		$wp_customize->add_control(
			...
			array(
				'description' 	=> '',
				'label' => esc_html__( 'Password Field', 'igrow-illinois' ),
				'section' => 'new_section',
		...
		$wp_customize->add_control(
			...
			array(
				'choices' => array(
					'choice1' => esc_html__( 'Choice 1', 'igrow-illinois' ),
					'choice2' => esc_html__( 'Choice 2', 'igrow-illinois' ),
					'choice3' => esc_html__( 'Choice 3', 'igrow-illinois' )
				),
				'description' 	=> '',
				'label' => esc_html__( 'Radio Field', 'igrow-illinois' ),
				'section' => 'new_section',
		...
		$wp_customize->add_control(
			...
			array(
				...
				'description' 	=> '',
				'label' => esc_html__( 'Select Field', 'igrow-illinois' ),
				'section' => 'new_section',
		...
		$wp_customize->add_control(
			...
			array(
				'description' 	=> '',
				'label' => esc_html__( 'Textarea Field', 'igrow-illinois' ),
				'section' => 'new_section',
		...
		$wp_customize->add_control(
			...
			array(
				...
				'label' => esc_html__( 'Range Field', 'igrow-illinois' ),
				'section' => 'new_section',
		...
		$wp_customize->add_control(
			...
			array(
				'description' 	=> '',
				'label' => esc_html__( 'Select Page', 'igrow-illinois' ),
				'section' => 'new_section',
		...
		$wp_customize->add_control(
			new WP_Customize_Color_Control(
				...
				array(
					'description' 	=> '',
					'label' => esc_html__( 'Color Field', 'igrow-illinois' ),
					'section' => 'new_section',
		...
		$wp_customize->add_control(
			new WP_Customize_Image_Control(
				...
				array(
					'description' 	=> '',
					'label' => esc_html__( 'File Upload', 'igrow-illinois' ),
					'section' => 'new_section',
		...
		$wp_customize->add_control(
			new WP_Customize_Image_Control(
				...
				array(
					'description' 	=> '',
					'label' => esc_html__( 'Image Field', 'igrow-illinois' ),
					'section' => 'new_section',
